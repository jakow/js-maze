...
function generateWalls(width, height) {
  ...
  for (var i = 0; i < height; ++i) {
    walls.push(new _Wall2.default(null, i * width));
  }
  // top wall of the maze
  for (var _i = 0; _i < width; ++_i) {
    walls.push(new _Wall2.default(null, _i));
  }
  // now create the rest of the cells
  for (var j = 0; j < height; ++j) {
    for (var _i2 = 0; _i2 < width; ++_i2) {
      var thisCell = cell(_i2, j, width, height);
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = (0, _getIterator3.default)(neighbours(_i2, j, width, height)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var neighbor = _step.value;

          var wall = new _Wall2.default(thisCell, neighbor);
          walls.push(wall);
...
var _shuffleArray = __webpack_require__(105);

var _shuffleArray2 = _interopRequireDefault(_shuffleArray);

var _rectangular = __webpack_require__(34);

var _rectangular2 = _interopRequireDefault(_rectangular);

var _UnionFind = __webpack_require__(56);
...
function generateMazeKruskal(width, height) {
  ...
  var allWalls = (0, _rectangular2.default)(width, height);
  allWalls = (0, _shuffleArray2.default)(allWalls.slice()); // shuffle a copy using fisher-yates
  // create
  var mazeWalls = [];
  // adjacency list of edges
  // stored as a map of cellNumber -> [adjacentCellNumbers]
  var maze = new _map2.default();
  // create a union-find (disjoint set) data structure which will keep track of which cells are
  // connected
  var uf = new _UnionFind2.default(width * height); // add cells to UF
  var _iteratorNormalCompletion = true;
  var _didIteratorError = false;
  var _iteratorError = undefined;

  try {
    for (var _iterator = (0, _getIterator3.default)(allWalls), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (cellA === null || cellB === null) {
        ...
        var connected = uf.find(cellA, cellB);
        if (!connected) {
...
var Maze = function Maze(width, height) {
...
window.eve = __webpack_require__(101)
...
var UnionFind = function () {
  ...
  function UnionFind(size) {
    (0, _classCallCheck3.default)(this, UnionFind);
  ...
  (0, _createClass3.default)(UnionFind, [{
    key: "root",
...
var dP          = __webpack_require__(4).f
  ...
  , ctx         = __webpack_require__(8)
  , anInstance  = __webpack_require__(20)
  , defined     = __webpack_require__(14)
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(49), __webpack_require__(102)))
...
var drawRectangularWalls = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(snap, walls, mazeWidth, mazeHeight, scale, style, animate) {
    var strokeWidth, lines, i, _i, _i2, _i3, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, line;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            for (i = 0; i < mazeWidth; ++i) {
              ...
              lines.push(snap.line(strokeWidth / 2 + scale * i, strokeWidth / 2, strokeWidth / 2 + scale * (i + 1), strokeWidth / 2));
            }
            // draw right vertical maze boundary
            for (_i = 0; _i < mazeHeight; ++_i) {
              lines.push(snap.line(strokeWidth / 2 + scale * mazeWidth, strokeWidth / 2 + scale * _i, strokeWidth / 2 + scale * mazeWidth, strokeWidth / 2 + scale * (_i + 1)));
            }
            // draw left vertical maze boundary
            for (_i2 = 0; _i2 < mazeHeight; ++_i2) {
              lines.push(snap.line(strokeWidth / 2, strokeWidth / 2 + scale * _i2, strokeWidth / 2, strokeWidth / 2 + scale * (_i2 + 1)));
            }
            // draw bottom horizontal maze boundary
            for (_i3 = 0; _i3 < mazeWidth; ++_i3) {
              lines.push(snap.line(strokeWidth / 2 + scale * _i3, strokeWidth / 2 + scale * mazeHeight, strokeWidth / 2 + scale * (_i3 + 1), strokeWidth / 2 + scale * mazeHeight));
            }
            ...
            walls.forEach(function (wall) {
              ...
              var x = cellA % mazeWidth;
              var y = Math.floor(cellA / mazeWidth);
              var startX = void 0;
              var startY = void 0;
              var endX = void 0;
              var endY = void 0;
              ...
              lines.push(snap.line(strokeWidth / 2 + scale * startX, strokeWidth / 2 + scale * startY, strokeWidth / 2 + scale * endX, strokeWidth / 2 + scale * endY));
            });
            // console.log(lines);
            ...
            _context.prev = 10;
            _iterator = (0, _getIterator3.default)(lines);
          ...
          case 12:
            ...
            _context.next = 17;
            return animateDraw(line, style, scale, 50);
  ...
  return function drawRectangularWalls(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return drawRectangularWalls(canvas, maze.walls, mazeWidth, mazeHeight, scale, wallStyle, true);
...
var _snapsvgCjs = __webpack_require__(55);

var _snapsvgCjs2 = _interopRequireDefault(_snapsvgCjs);

__webpack_require__(54);

var _Maze = __webpack_require__(50);
...
function animateDraw(line, style, lineLength, speed) {
  var startStyle = (0, _assign2.default)(style, {
    'stroke-dasharray': lineLength + ' ' + lineLength,
    'stroke-dashoffset': lineLength
  });
  var endStyle = { 'stroke-dashoffset': 0 };
...
function drawCoordinates(snap, width, height, scale) {
  ...
  try {
    for (var _iterator2 = (0, _getIterator3.default)(texts), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var t = _step2.value;
...
var maze = new _Maze2.default(mazeWidth, mazeHeight);
var grid = (0, _rectangular2.default)(mazeWidth, mazeHeight);
var gridStyle = {
